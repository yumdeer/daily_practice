...
/*	if(cameraselect==1)
		...
		if(cameraselect==0)
	{
	   ...
	   if(modalselect==2)
	   {
		   m_modalorg=modalorg13;
		  
	   }
	   if(modalselect==3)
	   {
		   m_modalorg=modalorg14;
...
void CModelEditDlg::OnOK() 
{
	...
	//	m_Windowedit.SetPart(xi,yi,-2*xi,-2*yi);
		...
		{
		ShapeModel13=ShapeModeledit;
		model13halfx=modelhalfx;
		model13halfy=modelhalfy;
		}
		if((modalselect==3)&&(cameraselect==0))
		{
		ShapeModel14=ShapeModeledit;
		model14halfx=modelhalfx;
		model14halfy=modelhalfy;
		}
	...
	if( m_EditModel == TRUE )
	{
		...
		{
			ShapeModel13=ShapeModeledit;
			modalorg13=m_modalorg;
		}
		if((modalselect==3)&&(cameraselect==0))
		{
		ShapeModel14=ShapeModeledit;
		modalorg14=m_modalorg;
		}
		if((modalselect==0)&&(cameraselect==1))
		{
		ShapeModel21=ShapeModeledit;
